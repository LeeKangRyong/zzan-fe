...
import type { AlcoholInfo, ImageWithDescription, PlaceInfo } from '../model/infoModel';
import type { LiquorDetailApiResponse, PlaceDetailApiResponse } from '../model/infoApiModel';
