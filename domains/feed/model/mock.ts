    ...
    images: [
      {
        ...
        imageUrl: require('@/assets/images/example_image.png'),
        tags: [
          { id: 'tag1', liquorId: '1', liquorName: '연천 율무 동동주', x: 0.4, y: 0.35 },
          { id: 'tag2', liquorId: '2', liquorName: '가평 잣막걸리', x: 0.65, y: 0.48 },
          { id: 'tag3', liquorId: '3', liquorName: '오곡 진상주', x: 0.53, y: 0.68 },
          { id: 'tag4', liquorId: '4', liquorName: '안동소주', x: 0.75, y: 0.53 },
        ],
      },
    ],
    score: 4.5,
    ...
    images: [
      {
        ...
        tags: [
          ...
          { id: 'tag6', liquorId: '6', liquorName: '복분자주', x: 0.62, y: 0.6 },
        ],
      },
    ],
    score: 3.8,
    ...
    images: [
      {
        ...
        imageUrl: require('@/assets/images/example_image.png'),
        tags: [
          { id: 'tag7', liquorId: '1', liquorName: '연천 율무 동동주', x: 0.5, y: 0.5 },
        ],
      },
    ],
    score: 4.2,
    ...
    images: [
      {
        ...
        tags: [
          ...
          { id: 'tag10', liquorId: '2', liquorName: '가평 잣막걸리', x: 0.5, y: 0.68 },
        ],
      },
    ],
    score: 4.8,
    ...
    images: [
      {
        ...
        imageUrl: require('@/assets/images/example_image.png'),
        tags: [
          { id: 'tag11', liquorId: '3', liquorName: '오곡 진상주', x: 0.45, y: 0.38 },
          { id: 'tag12', liquorId: '4', liquorName: '안동소주', x: 0.6, y: 0.62 },
        ],
      },
    ],
    score: 4.0,
    ...
    images: [
      {
        ...
        imageUrl: require('@/assets/images/example_image.png'),
        tags: [
          { id: 'tag14', liquorId: '1', liquorName: '연천 율무 동동주', x: 0.35, y: 0.35 },
          { id: 'tag15', liquorId: '6', liquorName: '복분자주', x: 0.65, y: 0.65 },
        ],
      },
    ],
    score: 4.3,
    ...
    images: [
      {
        ...
        imageUrl: require('@/assets/images/example_image.png'),
        tags: [
          { id: 'tag16', liquorId: '2', liquorName: '가평 잣막걸리', x: 0.5, y: 0.4 },
    ...
    images: [
      {
        ...
        imageUrl: require('@/assets/images/example_image.png'),
        tags: [
          { id: 'tag19', liquorId: '3', liquorName: '오곡 진상주', x: 0.38, y: 0.45 },
          { id: 'tag20', liquorId: '4', liquorName: '안동소주', x: 0.62, y: 0.55 },
    ...
    images: [
      {
        ...
        imageUrl: require('@/assets/images/example_image.png'),
        tags: [
          { id: 'tag22', liquorId: '6', liquorName: '복분자주', x: 0.4, y: 0.6 },
        ],
      },
    ],
    score: 4.1,
    ...
    images: [
      {
        ...
        imageUrl: require('@/assets/images/example_image.png'),
        tags: [
          { id: 'tag23', liquorId: '1', liquorName: '연천 율무 동동주', x: 0.3, y: 0.38 },
          { id: 'tag24', liquorId: '2', liquorName: '가평 잣막걸리', x: 0.5, y: 0.5 },
